...
namespace YellowTestProject
{
    ...
    public class LeagueTests
    {
        ...
        public void generateASchedule()
        {
            ...
            int game = 0;
            int week = 0;
            Assert.IsTrue(teams[0].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[1].equals(mySchedule[week, game].Away));
            game++;
            Assert.IsTrue(teams[2].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[7].equals(mySchedule[week, game].Away));
            game++;
            Assert.IsTrue(teams[3].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[6].equals(mySchedule[week, game].Away));
            game++;
            Assert.IsTrue(teams[4].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[5].equals(mySchedule[week, game].Away));
            week++;
            game = 0;
            ...
            Assert.IsTrue(teams[7].equals(mySchedule[week, game].Away));
            game++;
            Assert.IsTrue(teams[1].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[6].equals(mySchedule[week, game].Away));
            game++;
            Assert.IsTrue(teams[2].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[5].equals(mySchedule[week, game].Away));
            game++;
            Assert.IsTrue(teams[3].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[4].equals(mySchedule[week, game].Away));
            week++;
            game = 0;
            ...
            Assert.IsTrue(teams[6].equals(mySchedule[week, game].Away));
            game++;
            Assert.IsTrue(teams[7].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[5].equals(mySchedule[week, game].Away));
            game++;
            Assert.IsTrue(teams[1].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[4].equals(mySchedule[week, game].Away));
            game++;
            Assert.IsTrue(teams[2].equals(mySchedule[week, game].Home));
            Assert.IsTrue(teams[3].equals(mySchedule[week, game].Away));
            week++;
